...
let topCounter = 0;
const topArray = new Array("./images/tops/top_asymmetric.png", "./images/tops/top_scoop.png", "./images/tops/top_sweetheart.png", "./images/tops/top_vneck.png")
let skirtCounter = 0;
const skirtArray = new Array("./images/skirts/skirt_ballgown.png", "./images/skirts/skirt_line.png", "./images/skirts/skirt_mermaid.png", "./images/skirts/skirt_trumpet.png")
